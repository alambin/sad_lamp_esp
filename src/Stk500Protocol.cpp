...
Stk500Protocol::flash_page(uint8_t* load_addr, uint8_t* data)
{
    ...
    int     s        = load_address(load_addr[1], load_addr[0]);
...
Stk500Protocol::set_ext_prog_params()
{
    ...
    return exec_aram(0x45, params, sizeof(params));
}
...
Stk500Protocol::set_prog_params()
{
    ...
    return exec_aram(0x42, params, sizeof(params));
}

int
Stk500Protocol::load_address(uint8_t adr_hi, uint8_t adr_lo)
{
    uint8_t params[] = {adr_hi, adr_lo};
    return exec_aram(0x55, params, sizeof(params));
}
...
uint8_t
Stk500Protocol::exec_aram(uint8_t cmd, uint8_t* params, int count)
{
